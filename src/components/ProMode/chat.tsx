            ...
            {isMainRoute ? (
              <div className="flex-1 min-h-screen pb-[15vh] relative">
                ...
                <div className="main-container max-w-[900px] mx-auto scrollbar-hidden">
                    ...
                    <div className="result px-5 max-h-[70vh] overflow-y-auto flex flex-col gap-5 custom-scrollbar">
                      <div className="conversation">
                        {prevConversations.map((conversation, index) => (
                          <div key={index} className="conversation-item mb-6 animate-fadeIn">
                            {/* User Prompt */}
                            <div className="user-text flex justify-end items-center gap-3">
                              {conversation.prompt.includes('<img') ? (
                                ...
                                <div className="user-message bg-gradient-to-br from-yellow-200 via-yellow-100 to-yellow-50 text-gray-800 p-3 rounded-2xl max-w-[70%] text-right whitespace-pre-wrap shadow-lg hover:shadow-xl transition-all duration-300 border border-yellow-300/30">
                                  {conversation.prompt}
                                </div>
                              )}
                              <div className="user-avatar w-10 h-10 rounded-full bg-gradient-to-br from-yellow-200 to-yellow-400 p-0.5 transition-transform duration-300">
                                <img
                            ...
                            <div className="result-data flex items-start gap-4 mt-4">
                              <div className="ai-avatar w-10 h-10 rounded-full bg-gradient-to-br from-blue-200 to-blue-400 p-0.5 transition-transform duration-300">
                                <img
                                  className="w-full h-full rounded-full object-cover"
                              ...
                              {conversation.loading ? (
                                <div className="ai-message bg-gradient-to-br from-blue-50 via-blue-100 to-white p-3 rounded-2xl max-w-[70%] shadow-lg border border-blue-200/40">
                                  <div className="loader w-full flex flex-col gap-2">
                                    <div className="h-3 bg-gradient-to-r from-blue-200 to-blue-100 rounded-full animate-pulse" />
                                    <div className="h-3 bg-gradient-to-r from-blue-200 to-blue-100 rounded-full animate-pulse animation-delay-200" />
                                    <div className="h-3 bg-gradient-to-r from-blue-200 to-blue-100 rounded-full animate-pulse animation-delay-400" />
                                  </div>
                                </div>
                                ...
                                <div className="ai-message bg-gradient-to-br from-blue-50 via-blue-100 to-white text-gray-800 p-3 rounded-2xl max-w-[70%] whitespace-pre-wrap shadow-lg hover:shadow-xl transition-all duration-300 border border-blue-200/40">
                  ...
                  {/* Popup Button */}
                  {botState === 'finalizer_agent' && ( // Show button only if botState is 'finalizing'
                    <button
                  ...
                  {/* {botState === 'finalizer_agent' && ( // Show button only if botState is 'finalizing'
                    <button
                      ...
                      className="bg-[#f59699] text-white border border-white rounded-[10px] py-1.5 px-4 text-md cursor-pointer transition-colors duration-300 ease-in-out shadow-md hover:bg-[#B2801D] active:transform active:translate-y-0.5 ml-11 mt-2"
                    >
                      Proceed and generate image
                    </button>
                  )} */}

                  {botState === 'finalizer_agent' && (
                    <button
                      onClick={() => handleButtonClick({ text: 'Proceed and Generate Image', value: 'Proceed and Generate Image' })}
                      className="bg-[#f59699] text-white border border-white rounded-[10px] py-1.5 px-4 text-md cursor-pointer transition-colors duration-300 ease-in-out shadow-md hover:bg-[#B2801D] active:transform active:translate-y-0.5 ml-11 mt-2"
                    >
                      Proceed and Generate Image
                    </button>
