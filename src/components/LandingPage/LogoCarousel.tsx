...
const LogoCarousel: React.FC = () => {
  ...
  return (
    <div className="bg-[#fff9f5]">
      <div className="w-full inline-flex flex-nowrap overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-200px),transparent_100%)] bg-[#fff9f5] py-10">
        <ul
          ref={logosRef}
